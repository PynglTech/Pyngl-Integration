...
/analytics/${poll._id}`|| `https://192.168.1.12:5173/analytics/${poll._id}` || `https://pyngl.com/analytics/${poll.id}`  || "https://pyngl-integration.vercel.app/analytics/${poll._id}" // Adjust URL as needed
        };
