...
const oauth2callback = async (req, res) => {
  try {
    ...
    const CLIENT_URL = process.env.CLIENT_URL || "https://pyngl-whatsapp-integrations.vercel.app" || "https://pyngl.com"  || "https://www.pyngl.com"  || 'https://pyngl-integration.vercel.app'  ;               ;
