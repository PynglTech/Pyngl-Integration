...
<head>
  ...
  <style amp-custom>
    ...
    amp-selector[role="listbox"] div[option] {
      display:block;
      padding:12px 16px;
      margin:8px 0;
      border-radius:20px;
    ...
    amp-selector[role="listbox"] div[option][selected] {
...
<body>
  ...
  <div class="poll-container">
    ...
    <form method="post" action-xhr="https://api.pyngl.com/api/polls/vote-from-gmail" >
      ...
      ${
        poll.imageUrl
          ? `<amp-img src="https://pyngl.com/upload/${poll.imageUrl}" width="480" height="270" layout="responsive" class="poll-image" alt="Poll image"></amp-img>`
          : ""
      }
      ...
      <amp-selector name="opt" layout="container" role="listbox">
        ${poll.options
          .map(
            (opt) => `
            <div option="${opt.text}">${opt.text}</div>
          `
          )
          .join("")}
      </amp-selector>
  ...
  <div class="footer">
    ...
    <amp-img src="https://pyngl.com/assets/pynglLogoImage.png"
             alt="Pyngl Logo"
             width="100"
             height="35"
             layout="fixed">
