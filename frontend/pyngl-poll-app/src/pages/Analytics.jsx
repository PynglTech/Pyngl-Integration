...
const AnalyticsPollCard = ({ poll, onSelect }) => {
  ...
  return (
    <div
      className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden shadow-sm cursor-pointer hover:shadow-lg transition-shadow duration-300"
    ...
    >
      ...
      <div className="p-4">
        <div className="flex justify-between items-start mb-3">
          <h3 className="font-semibold text-gray-800 dark:text-gray-200 pr-2">
            {poll.question}
          </h3>
          <span
        ...
        <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700 pt-3 mt-3">
