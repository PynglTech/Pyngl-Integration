            ...
            <main className="p-4">
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-200">
                    <Section title="Welcome to Pyngl">
                        <p>These Terms and Conditions (“Terms”) govern your access to and use of Pyngl, operated by Experiencious (“Company,” “we,” “our,” or “us”). By using our website, mobile application, and related services (collectively, the “Services”), you agree to be bound by these Terms.</p>
                    </Section>
                    ...
                    <Section title="5. Contact Information">
                        ...
                        <address className="not-italic mt-2 bg-gray-100 p-4 rounded-lg text-sm">
                            ...
                            Email: <a href="mailto:contact@pyngl.com" className="text-blue-600 hover:underline">contact@pyngl.com</a>
                        </address>
                    </Section>
                </div>
            </main>
