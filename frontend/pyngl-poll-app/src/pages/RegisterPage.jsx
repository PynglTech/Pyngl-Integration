...
//   // Redirect to start if essential data is missing (e.g. on refresh)
//   useEffect(() => {
...
//   // Step 1: Register Form -> OTP
//   // Now accepts password to store it for the final step
...
//   // Final Step: DOB -> Create Account
//   const handleDobSuccess = async (dob) => {
//     const updatedData = { ...userData, dob };
//     setUserData(updatedData);

//     // If manual flow, we have everything now. CREATE USER.
//     if (userData.authType === "manual") {
