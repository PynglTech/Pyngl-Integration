...
    // This effect opens the correct sheet based on the URL
    useEffect(() => {
        if (location.pathname === '/login') {
            setActiveSheet('login');
        } else if (location.pathname === '/signup') {
            setActiveSheet('register');
       // --- 1. FIX: Added this case ---
...
    // --- 2. FIX: Updated openSheet logic ---
    const openSheet = (sheetName) => {
        clearError();
        
        // Create a map for easy URL lookup
        const pathMap = {
            login: '/login',
            register: '/signup',
...
a            {activeSheet === 'login' && <LoginSheet openSheet={openSheet} closeSheet={closeSheet} />}
            {activeSheet === 'register' && <RegisterSheet openSheet={openSheet} closeSheet={closeSheet} />}
            {activeSheet === 'forgot' && (
                <ForgotPasswordSheet
                    openSheet={openSheet}
