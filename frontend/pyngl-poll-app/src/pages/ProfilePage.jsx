            ...
            <div className="p-4 pb-24">
                ...
                <div className="border bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 shadow-sm rounded-2xl p-4 relative mt-10 mb-6">
                    ...
                    <div className="flex justify-around items-center my-4">
                        <div className="text-center">
                            <div className="text-3xl font-bold">{isLoadingStats ? '...' : stats.pingsCreated}</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400">Pings Created</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-bold">{isLoadingStats ? '...' : stats.totalParticipate}</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400">Total Participate</div>
                        </div>
                    </div>
                    <div className="flex justify-center space-x-2">
                        {['Week', 'Month', 'All-time'].map((filter) => (
                ...
                <div className="flex items-center justify-between p-4 rounded-2xl mb-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-sm text-gray-500 dark:text-gray-400">Turn on the night light</div>
                        </div>
                    </div>
                    <button onClick={toggleTheme} className={`relative w-12 h-6 rounded-full transition-colors duration-300 ${theme === 'dark' ? 'bg-gradient-to-r from-pink-500 to-purple-500' : 'bg-gray-300'}`}>
