...
// // // // // // // // The component uses dark: variants for bg/text/border as well
...
// // // // // // //     // Simulate Google result (email will be fetched in real integration)
// // // // // // //     const googleEmail = "user_google@example.com";

// // // // // // //     onSocialLogin && onSocialLogin("google", googleEmail);
// // // // // // //   };

// // // // // // //   const handleAppleLogin = () => {
// // // // // // //     // Simulate Apple result
...
// // // // // // //   // Password validation (Updated to match image rules)
// // // // // // //   useEffect(() => {
...
// // // // // // //     } else if (!hasUpper) {
// // // // // // //       setPasswordError("Must include (A-Z).");
// // // // // // //     } else if (!hasLower) {
// // // // // // //       setPasswordError("Must include (a-z).");
...
// // // // // // //     setTimeout(() => {
// // // // // // //       setLoading(false);
// // // // // // //       onSuccess && onSuccess(formData.email, formData.username);
// // // // // // //     }, 1500);
// // // // // // //   };
...
// // // // // // //   {/* Added 'shrink-0' to prevent header from squishing on small vertical screens */}
...
// // // // // // //   {/* Scrollable Area - Wraps the centered form */}
...
// // // // // // //           className="p-3 border border-gray-300 dark:border-[#2D3148] rounded-2xl hover:bg-gray-50 dark:hover:bg-[rgba(255,255,255,0.02)] transition bg-black"
...
// // // // // // import React, { useEffect, useRef, useState, useMemo } from "react";
// // // // // // import { useNavigate } from "react-router-dom";
// // // // // // import apiClient from "../../api/axiosConfig"; // ✅ Added API Client import
...
// // // // // //   // ✅ UPDATED: Real-time Username availability check
// // // // // //   useEffect(() => {
// // // // // //     const username = formData.username.trim();
...
// // // // // //   // ✅ UPDATED: Handle Submit with Real Backend Call
...
// // // // // //     try {
// // // // // //       // 1. Send OTP to Email
// // // // // //       await apiClient.post('/api/users/send-otp', { email: formData.email });
      
// // // // // //       // 2. Proceed to next step (Pass password so it can be stored in SignupFlow)
// // // // // //       if (onSuccess) {
// // // // // //         onSuccess(formData.email, formData.username, formData.password);
// // // // // //       }
// // // // // //     } catch (err) {
...
// // // // //       setEmailTaken(false);
// // // // //       // Leave local validation to the other useEffect
// // // // //       return;
// // // // //     }
...
// // // // //       !isCheckingUsername &&
// // // // //       !isCheckingEmail && // ✅ Check isCheckingEmail
// // // // //       agreedToTerms,
// // // // //     [
// // // // //       formData,
// // // // //       emailError,
...
// // // // //       // 2. Proceed (Pass password for final registration)
// // // // //       if (onSuccess) {
// // // // //         onSuccess(formData.email, formData.username, formData.password);
// // // // //       }
// // // // //     } catch (err) {
...
// // // // //                 }`}
// // // // //               />
// // // // //               {/* ✅ Show spinner inside email input if checking */}
// // // // //               {isCheckingEmail && (
// // // // //                 <Loader2 className="absolute right-3 top-1/2 -translate-y-1/2 h-5 w-5 animate-spin text-gray-400 dark:text-[#9aa4b2]" />
// // // // //               )}
// // // // //             </div>
...
// // // // // ✅ API CLIENT FIX:
// // // // // We set baseURL to "" to force relative paths.
// // // // // This makes requests go to http://192.168.x.x:5173/api/..., which Vite proxies to port 5000.
...
// // // // // --- Validation Helper Component ---
// // // // const ValidationMessage = ({ text, type = "error" }) => {
// // // //   const base = "p-3 rounded-lg flex items-start mt-2 border transition-colors duration-150";
// // // //   if (type === "error") {
// // // //     return (
// // // //       <div className={`${base} bg-pink-50 text-pink-600 border-pink-100 dark:bg-[rgba(255,77,116,0.06)] dark:text-[#ffb3c0] dark:border-[rgba(255,77,116,0.12)]`}>
// // // //         <span className="mr-2 text-lg leading-tight">😒</span>
// // // //         <span className="text-sm font-medium">{text}</span>
// // // //       </div>
// // // //     );
// // // //   }
// // // //   return (
// // // //     <div className={`${base} bg-blue-50 text-blue-600 border-blue-100 dark:bg-[rgba(84,103,254,0.06)] dark:text-[#cfe0ff] dark:border-[rgba(84,103,254,0.12)]`}>
// // // //       <span className="mr-2 text-lg leading-tight">•</span>
// // // //       <span className="text-sm font-medium">{text}</span>
// // // //     </div>
// // // //   );
...
// // // //   const handleGoogleLogin = () => {
// // // //     // ✅ DYNAMIC URL FIX: 
// // // //     // Constructs the backend URL using the current hostname (localhost or 192.168.x.x)
// // // //     // but changes the port to 5000. This ensures mobile devices connect to the right server.
...
// // // //         const { data } = await apiClient.post('/api/users/check-username', { username });
// // // //         if (data.available) {
// // // //           setUsernameTaken(false);
// // // //           setUsernameSuggestions([]);
// // // //         } else {
...
// // // //       // Pass data up to SignupFlow (Including password!)
// // // //       if (onSuccess) {
// // // //         onSuccess(formData.email, formData.username, formData.password);
// // // //       }
// // // //     } catch (err) {
...
// // // //           <p className="text-sm text-gray-500 dark:text-[#cbd5e1] mb-6 font-medium text-center">Step 1 of 3 (Account Credentials)</p>
...
// // // //             {usernameTaken && (
// // // //               <div>
// // // //                 <ValidationMessage text="Username already taken try one of these:" type="error" />
// // // //                 <div className="flex flex-wrap gap-2 mt-2">
// // // //                   {usernameSuggestions.map((suggestion, index) => (
// // // //                     <button key={index} type="button" onClick={() => applySuggestion(suggestion)} className="px-4 py-1.5 bg-pyngl-pink text-white text-sm font-semibold rounded-full hover:bg-pyngl-pink-dark transition">
// // // //                       {suggestion}
// // // //                     </button>
// // // //                   ))}
// // // //                 </div>
...
// // // //                 disabled={loading}
// // // //                 className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pyngl-pink bg-white dark:bg-[#1B1F33] text-gray-900 dark:text-[#F1F1F1] placeholder-gray-400 dark:placeholder-[#7b8393] transition-colors duration-150 ${
// // // //                   emailError || emailTaken ? "border-red-500 dark:border-red-400" : "border-gray-300 dark:border-[#2D3148]"
// // // //                 }`}
// // // //               />
// // // //               {isCheckingEmail && (
// // // //                 <Loader2 className="absolute right-3 top-1/2 -translate-y-1/2 h-5 w-5 animate-spin text-gray-400 dark:text-[#9aa4b2]" />
...
// // // //             </div>
// // // //             {emailError && <ValidationMessage text={emailError} type="error" />}
// // // //             {!emailError && emailTaken && <ValidationMessage text="Email is already registered." type="error" />}
// // // //           </div>
...
// // // //                 disabled={loading}
// // // //                 className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pyngl-pink bg-white dark:bg-[#1B1F33] text-gray-900 dark:text-[#F1F1F1] placeholder-gray-400 dark:placeholder-[#7b8393] transition-colors duration-150 ${
// // // //                   passwordError ? "border-red-500 dark:border-red-400" : "border-gray-300 dark:border-[#2D3148]"
// // // //                 }`}
// // // //               />
// // // //               <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-[#9aa4b2] p-1">
// // // //                 {showPassword ? <EyeOff className="h-5 w-5" /> : <Eye className="h-5 w-5" />}
// // // //               </button>
// // // //             </div>
// // // //             {passwordError ? <ValidationMessage text={passwordError} type="error" /> : formData.password.length === 0 ? <ValidationMessage text={passwordGuide} type="info" /> : null}
// // // //           </div>
...
// // // //                 disabled={loading}
// // // //                 className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pyngl-pink bg-white dark:bg-[#1B1F33] text-gray-900 dark:text-[#F1F1F1] placeholder-gray-400 dark:placeholder-[#7b8393] transition-colors duration-150 ${
// // // //                   confirmPasswordError ? "border-red-500 dark:border-red-400" : "border-gray-300 dark:border-[#2D3148]"
// // // //                 }`}
// // // //               />
// // // //               <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-[#9aa4b2] p-1">
...
// // // //           {/* Terms */}
// // // //           <div className="flex items-start gap-3 pt-6">
// // // //             <input type="checkbox" id="terms" checked={agreedToTerms} onChange={(e) => setAgreedToTerms(e.target.checked)} disabled={loading} className="mt-1 h-4 w-4 rounded border-gray-300 text-pyngl-pink focus:ring-pyngl-pink dark:bg-[#1B1F33] dark:border-[#2D3148]" />
// // // //             <label htmlFor="terms" className="text-sm text-gray-600 dark:text-[#cbd5e1]">
// // // //               By tapping "Agree and continue", below you agree to the <span className="text-blue-600 underline cursor-pointer">Terms of services</span> and acknowledge that you have read the <span className="text-blue-600 underline cursor-pointer">Privacy policy</span>.
// // // //             </label>
// // // //           </div>

// // // //           {generalError && <div className="text-center text-red-600 text-sm p-2 bg-red-50 rounded-lg mt-4 dark:bg-[rgba(255,0,0,0.06)] dark:text-[#ffb3c0]">{generalError}</div>}

// // // //           {/* Continue Button */}
// // // //           <div className="pt-6">
// // // //             <button onClick={handleSubmit} disabled={loading || !isFormValid} className="w-full py-3.5 px-4 text-white font-semibold rounded-full shadow-md transition-all bg-pyngl-pink hover:bg-pyngl-pink-dark disabled:bg-gray-400 flex items-center justify-center">
...
// // // //             </div>
// // // //             <div className="relative flex justify-center">
// // // //               <span className="bg-white dark:bg-[#131526] px-4 text-sm text-[#5467FE]">OR</span>
// // // //             </div>
// // // //           </div>
// // // //           <p className="text-sm text-gray-500 dark:text-[#cbd5e1] text-center mb-4">Continue with</p>

// // // //           <div className="flex justify-center gap-4 pb-12">
// // // //             <button onClick={handleGoogleLogin} className="p-3 border border-gray-300 dark:border-[#2D3148] rounded-2xl hover:bg-gray-50 dark:hover:bg-[rgba(255,255,255,0.02)] transition" aria-label="Continue with Google">
// // // //               <svg className="h-6 w-6" viewBox="0 0 24 24">
...
// // // //               </svg>
// // // //             </button>
// // // //             <button onClick={handleAppleLogin} className="p-3 border border-gray-300 dark:border-[#2D3148] rounded-2xl hover:bg-gray-50 dark:hover:bg-[rgba(255,255,255,0.02)] transition bg-black" aria-label="Continue with Apple">
// // // //               <svg className="h-6 w-6" fill="white" viewBox="0 0 24 24">
// // // //                 <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
// // // //               </svg>
// // // //             </button>
...
// // // // -------------------------------------------------------------------
// // // // This automatically detects if you are on localhost or 192.168.x.x
// // // // and connects to port 5000 on that same IP.
// // // const getBackendURL = () => {
// // //   try {
...
// // //   const handleGoogleLogin = () => {
// // //     // ✅ Updated dynamic link (uses the same logic as apiClient)
...
// // //             <input type="checkbox" id="terms" checked={agreedToTerms} onChange={(e) => setAgreedToTerms(e.target.checked)} disabled={loading} className="mt-1 h-4 w-4 rounded border-gray-300 text-pyngl-pink focus:ring-pyngl-pink dark:bg-[#1B1F33] dark:border-[#2D3148]" />
// // //             <label htmlFor="terms" className="text-sm text-gray-600 dark:text-[#cbd5e1]">
// // //               By tapping "Agree and continue", below you agree to the <span className="text-blue-600 underline cursor-pointer" onClick={() => navigate("/terms-of-service")}>Terms of services</span> and acknowledge that you have read the <span className="text-blue-600 underline cursor-pointer" onClick={() => navigate("/privacy-policy")}>Privacy policy</span>.
// // //             </label>
// // //           </div>
...
// //         <p className="text-gray-500 dark:text-gray-400 mb-8">Enter your details to get started.</p>
