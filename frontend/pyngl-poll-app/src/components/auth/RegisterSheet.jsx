...
// // Note: This is a hack for the single file setup to support the color from the original code.
// const CustomStyles = () => (
//   <style>
//     {`
//       .bg-pyngl-pink {
//         background-color: #ec4899; /* Approximate bright pink/fuchsia */
//       }
//       .hover\\:bg-pyngl-pink-dark:hover {
//         background-color: #db2777;
//       }
//       .text-pyngl-pink {
//         color: #ec4899;
//       }
//       .focus\\:ring-pyngl-pink:focus {
//         --tw-ring-color: #ec4899;
//       }
//       /* Custom utility for OTP input focus */
//       .otp-input:focus {
//         border-color: #ec4899;
...
// // --- OTP Verification Component (New Screen) ---
...
//     // Clear OTP for user to re-enter
...
//         <button
//           onClick={onBack}
//           className="absolute left-4 p-2 hover:bg-gray-100 rounded-full transition-colors disabled:opacity-50"
//           disabled={loading}
//         >
...
//           Enter the code sent to <strong className="font-medium text-gray-800">{email}</strong>
//         </p>
...
//               disabled={loading}
//               className={`otp-input w-12 h-14 text-center text-2xl font-mono border-2 rounded-xl transition-all shadow-sm
//                 ${error ? 'border-red-500' : 'border-gray-300 focus:border-pyngl-pink'}
...
//           className="w-full py-4 bg-pyngl-pink text-white font-semibold rounded-full shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl hover:bg-pyngl-pink-dark focus:outline-none focus:ring-4 focus:ring-pyngl-pink focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
//         >
//           {loading ? (
//             <>
...
// // --- Register Sheet Component (Modified) ---
// const RegisterSheet = ({ onBack, onSuccess, loading, setLoading }) => {
...
//       if (!(/[a-z]/.test(password) && /[A-Z]/.test(password))) errors.push("both (A-Z) & (a-z)");

//       if (errors.length > 0) {
//         setPasswordError(`Must include: ${errors.join(', ')}`);
//       } else {
//         setPasswordError("");
//       }
//     } else {
...
//       agreedToTerms
//     );
//   }, [formData, emailError, passwordError, confirmPasswordError, usernameTaken, agreedToTerms]);
...
//     // Simulate Registration API call (which triggers OTP email send)
//     setTimeout(() => {
//       setLoading(false);
//       // On successful registration, proceed to OTP screen
...
//                 className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pyngl-pink disabled:bg-gray-100 disabled:cursor-not-allowed
//                   ${usernameTaken ? 'border-red-500' : 'border-gray-300 focus:border-pyngl-pink'}`}
//               />
...
//                         className="px-3 py-1 bg-pyngl-pink text-white text-xs font-medium rounded-full hover:shadow-md transition-shadow"
//                       >
//                         {suggestion}
//                       </button>
//                     ))}
...
//                 disabled={loading}
//                 className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pyngl-pink disabled:bg-gray-100 disabled:cursor-not-allowed
//                   ${emailError ? 'border-red-500' : 'border-gray-300 focus:border-pyngl-pink'}`}
//               />
//             </div>
//             {/* Email Error */}
//             {emailError && (
...
//                 disabled={loading}
//                 className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pyngl-pink disabled:bg-gray-100 disabled:cursor-not-allowed
//                   ${passwordError ? 'border-red-500' : 'border-gray-300 focus:border-pyngl-pink'}`}
//               />
//               <button
//                 type="button"
...
//                 disabled={loading}
//                 className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pyngl-pink disabled:bg-gray-100 disabled:cursor-not-allowed
//                   ${confirmPasswordError ? 'border-red-500' : 'border-gray-300 focus:border-pyngl-pink'}`}
//               />
//               <button
//                 type="button"
...
//               className="mt-1 h-4 w-4 rounded border-gray-300 text-pyngl-pink focus:ring-pyngl-pink"
//               disabled={loading}
//             />
...
//           {generalError && (
//             <div className="text-center text-red-600 text-sm mt-4 p-2 bg-red-50 rounded-lg">
//               {generalError}
//             </div>
//           )}
...
//               className="w-full py-3.5 px-4 bg-pyngl-pink text-white font-semibold rounded-full shadow-md transition-all duration-300 ease-in-out hover:shadow-lg hover:bg-pyngl-pink-dark focus:outline-none focus:ring-4 focus:ring-pyngl-pink focus:ring-offset-2 focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
//             >
//               {loading ? (
//                 <>
//                   <Loader2 className="mr-2 h-5 w-5 animate-spin" />
...
//               <span className="bg-white px-4 text-sm text-[#5467FE] font-medium">OR</span>
//             </div>
//           </div>
...
//               <button
//                 type="button"
//                 className="p-3 border border-gray-300 rounded-2xl hover:bg-gray-50 transition-colors"
//                 disabled={loading}
//               >
...
//               <button
//                 type="button"
//                 className="p-3 border border-gray-300 rounded-2xl hover:bg-gray-50 transition-colors bg-black"
//                 disabled={loading}
//               >
...
// const App = () => {
//   const [currentPage, setCurrentPage] = useState('register'); // 'register', 'otp', 'success'
//   const [registeredEmail, setRegisteredEmail] = useState('');
//   const [loading, setLoading] = useState(false);

//   // Function to handle successful registration and move to OTP screen
...
//   // Function to handle back button (simplified for this single-screen demo)
//   const handleBack = () => {
//     if (currentPage === 'register') {
//       console.log("Navigating back to Login/Home.");
//       alert("Simulated: Navigating back to Login/Home.");
...
//           <h1 className="text-2xl font-bold">Error: Unknown state</h1>
//           <button onClick={() => setCurrentPage('register')} className="mt-4 text-blue-500 underline">Start Registration</button>
//         </div>
//       );
//   }
