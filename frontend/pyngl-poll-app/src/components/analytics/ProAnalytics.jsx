  ...
  return (
   ...
   {/* --- Buttons Below Vote Velocity Chart --- */}
        <div className="px-4 mb-8 flex gap-3">
          <button className="flex-1 bg-purple-500 hover:bg-purple-600 text-white py-3 rounded-xl font-semibold transition-colors text-md" onClick={() => navigate("/compare")}>
            Compare last 5 polls
          </button>
          <button className="flex-1 bg-teal-500 hover:bg-teal-600 text-white py-3 rounded-xl font-semibold transition-colors text-md">
            + Create segment
          </button>
        </div>
