    ...
    if (poll.deviceBreakdown && Object.keys(poll.deviceBreakdown).length > 0) {
      fastestDevice = Object.entries(poll.deviceBreakdown).reduce(
        (fastest, [device, count]) => {
          return count > (poll.deviceBreakdown[fastest] || 0) ? device : fastest;
        },
        "Mobile"
      );
    }
        ...
        <div className="space-y-5">
          <div className="flex items-center gap-4">
            <svg width="50" height="30" viewBox="0 0 50 30" className="flex-shrink-0">
              ...
              <path d="M 0 25 Q 12 20 25 10 T 50 5 L 50 30 L 0 30 Z" fill="url(#upGradient)" />
              <path d="M 0 25 Q 12 20 25 10 T 50 5" fill="none" stroke="#ec4899" strokeWidth="2.5" strokeLinecap="round" />
            </svg>
          ...
          <div className="flex items-center gap-4">
            <svg width="50" height="30" viewBox="0 0 50 30" className="flex-shrink-0">
              <defs>
                <linearGradient id="steadyGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stopColor="#a855f7" stopOpacity="0.3" />
                  <stop offset="100%" stopColor="#a855f7" stopOpacity="0.05" />
                </linearGradient>
              </defs>
              <path d="M 0 15 L 50 15 L 50 30 L 0 30 Z" fill="url(#steadyGradient)" />
              <path d="M 0 15 L 50 15" fill="none" stroke="#a855f7" strokeWidth="2.5" strokeLinecap="round" />
            </svg>
            <p className="text-sm text-gray-900 dark:text-gray-100">
              → Activity is steady.
            </p>
          ...
          <div className="flex items-center gap-4">
            <svg width="50" height="30" viewBox="0 0 50 30" className="flex-shrink-0">
              ...
              <path d="M 0 5 Q 12 10 25 18 T 50 25 L 50 30 L 0 30 Z" fill="url(#downGradient)" />
              <path d="M 0 5 Q 12 10 25 18 T 50 25" fill="none" stroke="#ec4899" strokeWidth="2.5" strokeLinecap="round" />
            </svg>
            <p className="text-sm text-gray-900 dark:text-gray-100">
...
const handleExportCSV = () => {
  ...
  <div className="flex gap-3">
    <button
      ...
      className="flex items-center gap-1 bg-pink-500 text-white px-3 py-1.5 rounded-lg hover:bg-pink-600 transition"
    >
      <Download size={16} /> PDF
    </button>
    <button
      onClick={handleExportCSV}
      className="flex items-center gap-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-3 py-1.5 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition"
    >
          ...
          return (
            <div className="relative h-32">
              ...
              <div className="flex justify-between mt-2 text-xs text-gray-400 dark:text-gray-500">
                {timeline.map((slot, i) => {
                  const showLabel = timeline.length <= 6 || i % Math.ceil(timeline.length / 4) === 0;
                  return (
          ...
          <div className="space-y-2">
            {poll.platformBreakdown &&
              Object.entries(poll.platformBreakdown).map(([name, count]) => {
                ...
                return (
                  <PlatformRow key={name} name={name} percentage={percentage} />
                );
              })}
          </div>
        </div>
